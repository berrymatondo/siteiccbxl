  ...
  return (
    <div className="@container">
      <div className="px-0 sm:px-4 py-0 sm:py-3">
        <div className="relative bg-zinc-900 sm:rounded-xl min-h-[420px] shadow-lg overflow-hidden">
          ...
          <div className="relative flex flex-col justify-end min-h-[420px]">
            <div className="p-6">
              ...
              <p className="text-center text-gray-200 text-xs font-medium leading-relaxed ">
                Que vous soyez dans la foi ou fidèle à Jésus depuis des années,{" "}
                <span className="max-md:hidden">
                  {" "}
                  <br />{" "}
                </span>{" "}
                il y a une place pour vous à Impact Centre Chrétien(ICC), chez nous et dans notre famille.
              </p>
            ...
            {editImages.map((image, index) => (
              <div key={index} className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <label htmlFor={`file-upload-${index}`} className="flex-1 cursor-pointer">
