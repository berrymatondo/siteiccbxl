...
import { Menu, X, Home, Info, Calendar, Mail, Users, LibraryBig, ChevronDown, LogIn } from "lucide-react"
...
export function TopNav() {
  ...
  const handleLoginClick = () => {
    alert("Fonctionnalité de connexion à venir. Vous pourrez bientôt accéder à votre espace membre.")
  }
      ...
      <nav className="sticky top-0 z-50 bg-black/95 backdrop-blur-md border-b border-gray-800">
        <div className="flex items-center justify-between px-4 md:px-8 h-16 max-w-7xl mx-auto">
          ...
          <Link href="/" className="flex flex-col items-center gap-0.5">
            ...
            <span className="text-white text-[10px] font-medium tracking-wider">BRUXELLES</span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/teachings" className="text-white hover:text-gray-300 transition-colors text-sm font-medium">
              Enseignements
            </Link>
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="hidden md:flex items-center gap-2 bg-white text-black px-6 py-2 rounded-lg font-medium hover:bg-gray-100 transition-colors text-sm"
            >
            ...
            <nav className="flex flex-col">
              {menuItems.map((item) => (
                ...
                >
                  ...
                  <span className="text-[#141117] dark:text-white font-medium">{item.label}</span>
                </Link>
              ))}
              <button
                onClick={() => {
